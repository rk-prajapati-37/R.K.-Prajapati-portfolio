  ...
  return (
    <TiltCard className="h-full rounded-xl">
      <div
        ...
        className="card cursor-pointer focus:outline-none h-full flex flex-col !p-0 overflow-hidden"
      ...
      >
        ...
        <div className="relative overflow-hidden rounded-t-xl bg-gray-200 h-48 flex-shrink-0">
          {project.imageUrl ? (
            <>
              ...
              >
                <motion.button
                  className="px-6 py-2 bg-red-600 !text-white rounded-full font-semibold shadow-lg shadow-red-600/40"
        ...
        <div className="p-6 flex-grow flex flex-col">
          <h3 className="text-xl font-bold text-gray-800 mb-2 line-clamp-3">{project.title || "Untitled"}</h3>
          <div className="text-gray-600 text-sm mb-4 flex-grow">
            <PortableTextClient value={project.description || "No description"} truncate={false} className="line-clamp-3" />
          </div>
          ...
          {project.techStack && project.techStack.length > 0 && (
            <div className="flex flex-wrap gap-2 mb-4">
              ...
              {project.techStack.length > 3 && (
                <span className="px-3 py-1 text-gray-400 text-xs font-semibold">+{project.techStack.length - 3} more</span>
              )}
            </div>
          )}
